...
export function TermsPage() {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions - Appsoleum</title>
        <meta name="description" content="Read Appsoleum's terms and conditions for using our legacy preservation platform." />
        <meta property="og:title" content="Terms & Conditions - Appsoleum" />
        <meta property="og:description" content="Read Appsoleum's terms and conditions for using our legacy preservation platform." />
